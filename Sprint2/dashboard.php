...
<body>
    ...
    <div id="lever" style="display: none;" ><?=$_SESSION['user']['lever'] ?></div>
    <div class="wrapper">
        <div class='sidebar'>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        ?>
                            ...
                            <?php } ?>
                            <li class="nav-item nav-child">
                                <a class="nav-link" href="index.php?category=editACC&id=<?=$_SESSION['user']['id']  ?>">
